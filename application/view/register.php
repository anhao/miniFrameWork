...
<div class="layui-form layui-form-pane">
    <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="password" name="notpassword" id="notpassword" class="layui-input">
                </div>
    ...
    <script>
        ...
        function login() {
            ...
            var notpassword = $.trim($('#notpassword').val());
            if (username == '') {
                return false;
            }
            if (password == '') {
            ...
            $.post('/Account/doregister', {'username': username, 'password': password,'notpassword':notpassword}, function (res) {
                // layer.alert(res.msg);
                if (res.code > 0) {
